      ...
      <main className="p-8 space-y-8 items-center justify-center">
        ...
        <section className="bg-zinc-800 p-6 rounded-lg shadow-lg">
          ...
          <p className="text-gray-400">
            Shopify Inc. is a leading e-commerce platform that enables businesses to create online stores and manage their sales
            and operations. It provides an all-in-one solution for entrepreneurs and large companies alike to sell products
