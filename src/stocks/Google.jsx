...
const Google = () => {
  const [stockData, setStockData] = useState({
    symbol: 'GOOGL',
    name: 'Alphabet',
    price: 1512.12,  // Google stock price, change as needed
    historicalPrices: {
  ...
  return (
    <div className="min-h-screen bg-zinc-900 text-white">
      {/* Header Section */}
      <header className="flex justify-between items-center pl-16 p-6 bg-zinc-800">
        <div className="flex items-center space-x-4">
          <img src="https://upload.wikimedia.org/wikipedia/commons/2/2f/Google_2015_logo.svg" alt="Google" className="w-24 h-14 rounded-full" />
      ...
      <main className="p-8 space-y-8 items-center justify-center">
        ...
        <section className="bg-zinc-800 p-6 rounded-lg shadow-lg">
          ...
          <p className="text-gray-400">
            Google (Alphabet Inc.) is a multinational technology company specializing in Internet-related services and products, which include online advertising, search engines, cloud computing, and software.
          </p>
        </section>
