    ...
    <div className="min-h-screen bg-zinc-900 text-white">
      ...
      <header className="flex justify-between items-center pl-24 p-6 bg-zinc-800">
        <div className="flex items-center space-x-4">
          <img
            src="https://www.nvidia.com/content/nvidiaGDC/us/en_US/about-nvidia/legal-info/logo-brand-usage/_jcr_content/root/responsivegrid/nv_container_392921705/nv_container/nv_image.coreimg.100.1070.png/1703060329053/nvidia-logo-vert.png"
            alt="Nvidia Logo"
            className="w-28 h-16"
          />
      ...
      <main className="p-8 space-y-8 items-center justify-center">
        ...
        <section className="bg-zinc-800 p-6 rounded-lg shadow-lg">
          ...
          <p className="text-gray-400">
            ...
            The company was founded in 1993 by Jensen Huang, Chris Malachowsky, and Curtis Priem. Nvidia designs graphics processing units (GPUs),
            as well as system on a chip (SoC) units for mobile computing and automotive market.
          </p>
        </section>
        ...
        <section className="text-center space-x-4">
          {['1d', '1w', '1m', '6m', '1y', '5y', 'all'].map((timeframeOption) => (
            <button
              key={timeframeOption}
              className={`py-1 px-4 rounded-full transition duration-300 ${timeframe === timeframeOption ? 'bg-yellow-600' : 'bg-gray-700'}`}
