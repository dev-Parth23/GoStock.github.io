...
const Microsoft = () => {
  ...
  return (
    <div className="min-h-screen bg-zinc-900 text-white">
      {/* Header Section */}
      <header className="flex justify-between items-center py-1 px-6 bg-zinc-800">
        <div className="flex items-center space-x-4">
          <img
            src="https://www.pngplay.com/wp-content/uploads/9/Microsoft-Logo-PNG-HD-Quality.png"
            alt="Microsoft Logo"
            className="w-36 h-32"
          />
      ...
      <main className="p-8 space-y-8 items-center justify-center">
        ...
        <section className="bg-zinc-800 p-6 rounded-lg shadow-lg">
          ...
          <p className="text-gray-400">
            Microsoft Corporation is a global technology company known for its software products, including
            the Windows operating system, Office suite, and its cloud services such as Azure.
          </p>
        </section>
